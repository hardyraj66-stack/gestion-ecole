...
export function QuickActions() {
  ...
  const actions = [
    {
      label: t('dashboard.nouvelleClasse'),
    ...
    {
      label: t('dashboard.nouvelEleve'),
      path: '/eleves/nouveau',
      icon: 'M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z',
    },
    {
      label: t('dashboard.saisirNotes'),
      path: '/notes',
      icon: 'M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z',
    },
    {
      label: t('dashboard.voirPlanning'),
      path: '/classes',
  ...
  return (
    <div className="card">
      <div className="card-header">
        <h3 className="card-title">{t('dashboard.accesRapides')}</h3>
      </div>
