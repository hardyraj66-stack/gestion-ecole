    ...
    <Card className="fiche-identite-card">
      ...
      {editing ? (
        ...
        <div className="fiche-details">
          {/* Ligne 1 : Date naissance + Classe */}
          <div className="fiche-detail-row">
            <div className="fiche-detail-cell">
              <span className="fiche-detail-label">
                <Icon path="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" size={13} />
                {t('fiche.identite.dateNaissance')}
              </span>
              <span className="fiche-detail-value">
                {formatDate(local.date_naissance)}{age !== null ? ` · ${age} ${t('elevesTable.ans')}` : ''}
              </span>
            </div>
            <div className="fiche-detail-cell">
              <span className="fiche-detail-label">
                <Icon path="M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z" size={13} />
                {t('fiche.identite.classe')}
              </span>
              <span className="fiche-detail-value">
          ...
          <div className="fiche-detail-divider" />

          {/* Ligne 2 : Salle + Téléphone */}
          <div className="fiche-detail-row">
            <div className="fiche-detail-cell">
              <span className="fiche-detail-label">
                <Icon path="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" size={13} />
                {classe?.salle_type === 'variable' ? t('fiche.identite.salleVariable') : t('fiche.identite.salle')}
              </span>
              <span className="fiche-detail-value">
                {salle
                  ? <>{salle}{classe?.salle_type === 'variable' && <Badge label={t('fiche.identite.salleVariableLabel')} variant="default" />}</>
                  : <span className="fiche-empty">{t('fiche.identite.salleNonAssignee')}</span>}
              </span>
            </div>
            <div className="fiche-detail-cell">
              <span className="fiche-detail-label">
                <Icon path="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" size={13} />
                {t('fiche.identite.telephone')}
              </span>
              <span className="fiche-detail-value">
                {local.telephone || <span className="fiche-empty">{t('fiche.identite.nonRenseigne')}</span>}
              </span>
            </div>
          </div>
          ...
          <div className="fiche-detail-cell">
            <span className="fiche-detail-label">
              <Icon path="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" size={13} />
              {t('fiche.identite.email')}
            </span>
            <span className="fiche-detail-value">
              {local.email
                ? <span className="fiche-detail-email">{local.email}</span>
                : <span className="fiche-empty">{t('fiche.identite.nonRenseigne')}</span>}
            </span>
          </div>
          ...
          <div className="fiche-detail-cell">
            <span className="fiche-detail-label">
              <Icon path="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" size={13} />
              {t('fiche.identite.adresse', { defaultValue: 'Adresse' })}
            </span>
            <span className="fiche-detail-value">
              {local.adresse || <span className="fiche-empty">{t('fiche.identite.nonRenseignee')}</span>}
            </span>
          </div>
        </div>
      )}
